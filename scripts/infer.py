...
from plots.generate_terrain_3d import generate_terrain_3d
from plots.generate_stream_dynamic import generate_stream_dynamic
...
def main():
    ...
    generate_terrain_3d(
        predictions_path=str(output_dir / "predictions.pt"),
        output_path=str(output_dir / "terrain_3d.html"),
    )
    ...
    generate_stream_dynamic(
        predictions_path=str(output_dir / "predictions.pt"),
        output_path=str(output_dir / "stream_dynamic.html"),
    )
